# App F1Challenge con autenticación con base de datos Firebase (Login, Registro, Home)

## Descripción general de F1Challege
...
2. Si no existe cuenta, registrate creando un nuevo usuario.
3. Visualizar pantalla de inicio con email del usuario autenticado.
4. Cerrar sesión y volver a pantalla de login.

## Credenciales de prueba

- **Email**: `f1challenge@gmail.com`
- **Contraseña**: `f1challenge123`